package org.stonkmonitor.config.lists
...
val wuchtlistQuotes: Map<String, QuoteSymbolMetaData> =
    linkedMapOf(
        ...
        "12DA.F" to QuoteSymbolMetaData(name = "Dell", industry = Industry.WUCHT),
        "CGI1.F" to QuoteSymbolMetaData(symbol = "COWN", industry = Industry.WUCHT),
        "HB6.F" to QuoteSymbolMetaData(symbol = "HIBB", industry = Industry.WUCHT),
        "T5Z.F" to QuoteSymbolMetaData(name = "Ternium", industry = Industry.WUCHT),
        "H6Q.F" to QuoteSymbolMetaData(name = "Himax", industry = Industry.WUCHT),
        "IPHB.F" to QuoteSymbolMetaData(name = "Impala", industry = Industry.WUCHT),
        "UCE.F" to QuoteSymbolMetaData(name = "Ultra Clean Holding", industry = Industry.WUCHT),
        "A28.F" to QuoteSymbolMetaData(name = "Affimed", industry = Industry.WUCHT),
        "CLIQ.F" to QuoteSymbolMetaData("Cliq Digital", industry = Industry.WUCHT),
        "DCO.F" to QuoteSymbolMetaData(name = "Deere", industry = Industry.WUCHT),
        "DEZ.F" to QuoteSymbolMetaData(name = "Deutz", industry = Industry.WUCHT),
        "4F1.F" to QuoteSymbolMetaData(name = "Fluidra", industry = Industry.WUCHT),
        "0G93.F" to QuoteSymbolMetaData(name = "Globus Maritime", industry = Industry.WUCHT),
        "1L8.F" to QuoteSymbolMetaData(name = "Loral Space", industry = Industry.WUCHT),
