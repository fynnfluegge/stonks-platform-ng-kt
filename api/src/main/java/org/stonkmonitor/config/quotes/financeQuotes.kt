...
val financeQuotes: Map<String, QuoteSymbolMetaData>
    get() {
        ...
        symbolNameMapping["SPGI"] = QuoteSymbolMetaData("SPGI", "S&P Global", "A2AHZ7", Industry.FINANCE, SubIndustry.EXCHANGE)
