...
object TechQuotes {
    val quotes: Map<String, QuoteSymbolMetaData>
        get() {
            ...
            symbolNameMapping["VEEV"] = QuoteSymbolMetaData("VEEV", "Veeva", "A1W5SA", Industry.TECH, SubIndustry.SAAS)
            ...
            symbolNameMapping["3CP.F"] = QuoteSymbolMetaData("3CP.F", "Xiaomi", "A2JNY1", Industry.TECH, SubIndustry.MANUFACTURING)
            ...
            symbolNameMapping["HMI"] = QuoteSymbolMetaData("HMI", "Huami", "", Industry.OTHER, SubIndustry.CHINA)
