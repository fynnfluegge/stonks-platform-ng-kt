...
object EnergyQuotes {
    val quotes: Map<String, QuoteSymbolMetaData>
        get() {
            ...
            symbolNameMapping["BLDP"] = QuoteSymbolMetaData("BLDP", "Ballard Power Systems", "A0RENB", Industry.ENERGY, SubIndustry.CONVENTIONAL)
            symbolNameMapping["D7G.F"] = QuoteSymbolMetaData("D7G.F", "Nel Asa", "A0B733", Industry.ENERGY, SubIndustry.CONVENTIONAL)
            symbolNameMapping["27W.F"] = QuoteSymbolMetaData("27W.F", "Powercell", "A14TK6", Industry.ENERGY, SubIndustry.CONVENTIONAL)
            symbolNameMapping["PLUG"] = QuoteSymbolMetaData("PLUG", "Plug Power", "A1JA81", Industry.ENERGY, SubIndustry.CONVENTIONAL)
