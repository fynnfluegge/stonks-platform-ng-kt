...
public class TechQuotes {
	...
	public static Map<String, QuoteSymbolMetaData> getQuotes(){
		...
		symbolNameMapping.put("GOOG", new QuoteSymbolMetaData("GOOG","Google","A14Y6F", Industry.FANG));
		symbolNameMapping.put("AAPL", new QuoteSymbolMetaData("AAPL","Apple","865985", Industry.FANG));
		symbolNameMapping.put("FB", new QuoteSymbolMetaData("FB","Facebook","A1JWVX", Industry.FANG));
		symbolNameMapping.put("AMZN", new QuoteSymbolMetaData("AMZN","Amazon","906866", Industry.FANG));
		symbolNameMapping.put("MSFT", new QuoteSymbolMetaData("MSFT","Microsoft","870747", Industry.FANG));
		symbolNameMapping.put("NFLX", new QuoteSymbolMetaData("NFLX","Netflix","552484", Industry.MEDIA));
		symbolNameMapping.put("BABA", new QuoteSymbolMetaData("BABA","Alibaba","A117ME", Industry.FANG));
		symbolNameMapping.put("TCEHY", new QuoteSymbolMetaData("TCEHY","Tencent","A1138D", Industry.FANG));
		symbolNameMapping.put("BIDU", new QuoteSymbolMetaData("BIDU","Baidu","A0F5DE", Industry.FANG));
