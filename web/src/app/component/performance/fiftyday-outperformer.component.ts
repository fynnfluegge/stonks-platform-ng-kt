...
@Component({
  selector: 'app-50day-outperformer-table',
  templateUrl: '../base-table/base-table.component.html',
  animations: [
    TableAnimations.animations
  ]
})
export class FiftydayOutperformerComponent extends BaseTableComponent {

  constructor(http: HttpClient, dialog: MatDialog) {
    super(new PollingService(http,
      'http://18.156.73.56:9091/get50dOutperformer',
      'http://18.156.73.56:9091/update50dOutperformer'),
      dialog);
  }
