...
@Component({
  selector: 'app-gastronomy-table',
  templateUrl: '../base-table/base-table.component.html',
  animations: [
    TableAnimations.animations
  ]
})
export class GastronomyComponent extends BaseTableComponent {

  constructor(http: HttpClient, dialog: MatDialog) {
    super(new PollingService(http,
      'http://18.156.73.56:9091/getGastronomyQuotes',
      'http://18.156.73.56:9091/updateGastronomyQuotes'),
      dialog);
  }
