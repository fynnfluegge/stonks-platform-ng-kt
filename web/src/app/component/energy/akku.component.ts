...
@Component({
  selector: 'app-akku-table',
  templateUrl: '../base-table/base-table.component.html',
  animations: [
    TableAnimations.animations
  ]
})
export class AkkuComponent extends BaseTableComponent {

  constructor(http: HttpClient, dialog: MatDialog) {
    super(new PollingService(http,
      'http://18.156.73.56:9091/getAkkuQuotes',
      'http://18.156.73.56:9091/updateAkkuQuotes'),
      dialog);
  }
