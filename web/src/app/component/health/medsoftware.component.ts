...
@Component({
  selector: 'app-medsoftware-table',
  templateUrl: '../base-table/base-table.component.html',
  animations: [
    TableAnimations.animations
  ]
})
export class MedsoftwareComponent extends BaseTableComponent {

  constructor(http: HttpClient, dialog: MatDialog) {
    super(new PollingService(http,
      'http://18.156.73.56:9091/getMedSoftwareQuotes',
      'http://18.156.73.56:9091/updateMedSoftwareQuotes'),
      dialog);
  }
