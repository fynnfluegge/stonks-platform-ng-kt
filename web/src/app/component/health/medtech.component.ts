...
@Component({
  selector: 'app-medtech-table',
  templateUrl: '../base-table/base-table.component.html',
  animations: [
    TableAnimations.animations
  ]
})
export class MedtechComponent extends BaseTableComponent {

  constructor(http: HttpClient, dialog: MatDialog) {
    super(new PollingService(http,
      'http://18.156.73.56:9091/getMedtechQuotes',
      'http://18.156.73.56:9091/updateMedtechQuotes'),
      dialog);
  }
